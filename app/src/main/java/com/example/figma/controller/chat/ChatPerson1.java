...
//import com.example.figma.model.Teacheritem1;
//
...
//
//
//    private TeacherRecyclerAdapter1 mRecyclerAdapter; // 아래에 있는 mRecyclerAdapter과 연결
//    private ArrayList<Teacheritem1> mTeacherItem;
//
//    // 다른페이지에서 채팅 버튼 눌렀을 때
//    @Override
...
//                Intent intent = new Intent(getApplicationContext(), ChatPerson1.class);
...
//        /* initiate adapter */
//        mRecyclerAdapter = new TeacherRecyclerAdapter1();
//
...
//        for(int i=1;i<=10;i++){
//            if(i%2==0)
//                mTeacherItem.add(new Teacheritem1(R.drawable.profile,"황선철교수님","02-950-0000"));
//            else
//                mTeacherItem.add(new Teacheritem1(R.drawable.profile,i+"번째 사람",i+"번째 상태메시지"));
//
//        }
