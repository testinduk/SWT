...
public class sharing_com_adapter extends RecyclerView.Adapter<sharing_com_adapter.ViewHolder> {

    private ArrayList<sharing_com_DB> arrayList;
    private Context context;

    public sharing_com_adapter(ArrayList<sharing_com_DB> arrayList, Context context) {
